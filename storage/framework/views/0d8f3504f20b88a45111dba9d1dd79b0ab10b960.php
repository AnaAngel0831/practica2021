                        ...
                        <tr>
                            ...
                            <td>
                                <?php if($task->status === \App\Models\Task::STATUS_CREATED): ?>
                                    <span class="badge bg-default"><?php echo e('Status is created'); ?></span>
                                <?php elseif($task->status === \App\Models\Task::STATUS_IN_PROGRESS): ?>
                                    <span class="badge bg-primary">  <?php echo e('Status is in progress'); ?></span>
                                <?php else: ?>
                                    <span class="badge bg-success">  <?php echo e('Status is done'); ?></span>
                                <?php endif; ?>
                            </td>
