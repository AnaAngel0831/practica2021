...
@section('content')
    ...
    <section class="content">
        ...
        <div class="modal-dialog">
             <form action="{{route('tasks.add',['id' => $board->id])}}" method="POST">
                @csrf
                <div class="modal-content">
                    <div class="modal-header">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="name" id="taskAddName" class="form-control @if ($errors->has('name')) is-invalid @endif" />
                        </div>
                    </div>
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                          ...
                          <textarea class="form-control" name="description" id="taskAddDescription" class="form-control @if ($errors->has('description')) is-invalid @endif" /></textarea>
                        </div>
                    </div>
                    <div class="modal-body">
                        @if ($errors->has('assignment'))
                            ...
                            <div class="form-group">
                                 ...
                                 <select class="custom-select rounded-0" name="assignment" id="taskAddAssignment" class="form-control @if ($errors->has('assignment')) is-invalid @endif">
                                     <option value="">Unassigned</option>
                                     @foreach ($boardUsers as $boardUser)
                                         <option value="{{$boardUser->user_id}}">{{$boardUser->user->name}}</option>
                                     @endforeach
                    ...
                    <div class="modal-body">
                        @if ($errors->has('status'))
                            ...
                            <div class="form-group">
                                      ...
                                      <select class="custom-select rounded-0" id="taskAddStatus" name="status" class="form-control @if ($errors->has('status')) is-invalid @endif">
                                          <option value="0">Created</option>
                                          <option value="1">In progress</option>
                                          <option value="2">Done</option>
                              </select>
