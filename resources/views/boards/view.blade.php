                        ...
                        <tr>
                            ...
                            <td>
                                @if($task->status === \App\Models\Task::STATUS_CREATED)
                                    <span class="badge bg-default">{{ 'Status is created' }}</span>
                                @elseif ($task->status === \App\Models\Task::STATUS_IN_PROGRESS)
                                    <span class="badge bg-primary">  {{'Status is in progress'}}</span>
                                @else
                                    <span class="badge bg-success">  {{'Status is done'}}</span>
                                @endif
                            </td>
